...
/**
 * Interface that defines the methods of a Silent Area Manager
 * @author Daniel Sanchez Quirós
 * @author Manuel Alejandro Cabeza Romero
 */
public interface ISilentAreasManager {
     ...
     */
    void getSilentArea(IOnSilentAreaInfoRetrievedCallback callbackInstance);
}
